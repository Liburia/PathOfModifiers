...
namespace PathOfModifiers.AffixesItem.Prefixes
{
    ...
    public class ArmorReflect : Prefix, ITieredStatFloatAffix
    {
        ...
        static float[] tiers = new float[] { 0.5f, 0.75f, 1f, 1.25f, 1.5f, 1.75f, 2f };
        ...
        {
            return $"{(int)Math.Round(Math.Abs(multiplier * 100))}% melee damage reflected";
        }
