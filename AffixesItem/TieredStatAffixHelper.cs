...
namespace PathOfModifiers.AffixesItem
{
    public static class TieredAffixHelper
    {
        ...
        #endregion
        #region ITieredStatFloat3Affix
        public static void SetTier(ITieredStatFloat3Affix affix, int t1, int t2, int t3, bool ignore1 = false, bool ignore2 = false, bool ignore3 = false)
        {
            if (!ignore1)
            {
                affix.Tier1 = t1;
        ...
        public static void SetTierMultiplier(ITieredStatFloat3Affix affix, float m1, float m2, float m3, bool ignore1 = false, bool ignore2 = false, bool ignore3 = false)
        {
            if (!ignore1)
            {
                affix.TierMultiplier1 = m1;
            ...
            if (!ignore3)
            {
                affix.TierMultiplier3 = m3;
                affix.Multiplier3 = affix.Tiers3[affix.Tier3] + (affix.Tiers3[affix.Tier3 + 1] - affix.Tiers3[affix.Tier3]) * m3;
            }
        }
        public static Affix Clone(ITieredStatFloat3Affix affix, ITieredStatFloat3Affix newAffix)
        {
            SetTier(newAffix, affix.Tier1, affix.Tier2, affix.Tier3);
            SetTierMultiplier(newAffix, affix.TierMultiplier1, affix.TierMultiplier2, affix.TierMultiplier3);

            return (Affix)newAffix;
        }
        public static void RollTier(ITieredStatFloat3Affix affix, bool ignore1 = false, bool ignore2 = false, bool ignore3 = false)
        {
            int wr1 = -1;
            int wr2 = -1;
            int wr3 = -1;
        ...
        public static void RollTierMultiplier(ITieredStatFloat3Affix affix, bool ignore1 = false, bool ignore2 = false, bool ignore3 = false)
        {
            SetTierMultiplier(affix, Main.rand.NextFloat(0, 1), Main.rand.NextFloat(0, 1), Main.rand.NextFloat(0, 1), ignore1, ignore2, ignore3);
        }
        public static void RollValue(ITieredStatFloat3Affix affix, bool rollTier)
        {
            if (rollTier)
                RollTier(affix);
            RollTierMultiplier(affix);
        }
        public static void ReforgePrice(ITieredStatFloat3Affix affix, Item item, ref int price)
        {
            price += (int)Math.Round(item.value * 0.2f * affix.CompoundTier / 4 / affix.Weight);
        }
        public static void Save(ITieredStatFloat3Affix affix, TagCompound tag, Item item)
        {
            tag.Set("tier1", affix.Tier1);
            tag.Set("tierMultiplier1", affix.TierMultiplier1);
            tag.Set("tier2", affix.Tier2);
            ...
            tag.Set("tierMultiplier3", affix.TierMultiplier3);
        }
        public static void Load(ITieredStatFloat3Affix affix, TagCompound tag, Item item)
        {
            SetTier(affix, tag.GetInt("tier1"), tag.GetInt("tier2"), tag.GetInt("tier3"));
            SetTierMultiplier(affix, tag.Get<float>("tierMultiplier1"), tag.Get<float>("tierMultiplier2"), tag.Get<float>("tierMultiplier3"));
        }
        public static void NetSend(ITieredStatFloat3Affix affix, Item item, BinaryWriter writer)
        {
            writer.Write(affix.Tier1);
            writer.Write(affix.TierMultiplier1);
            writer.Write(affix.Tier2);
            ...
            writer.Write(affix.TierMultiplier3);
        }
        public static void NetReceive(ITieredStatFloat3Affix affix, Item item, BinaryReader reader)
        {
            int t1 = reader.ReadInt32();
            float tm1 = reader.ReadSingle();
            int t2 = reader.ReadInt32();
            ...
            SetTierMultiplier(affix, tm1, tm2, tm3);
        }
        public static string GetForgeText(ITieredStatFloat3Affix affix, Item item)
        {
            return $"[T{affix.CompoundTierText}] {affix.GetTolltipText(item)}";
        }
        #endregion
