...
{
    public class WeaponMagmaOrb : Suffix, ITieredStatFloat3Affix
    {
        ...
        static float[] tiers3 = new float[] { -0.3f, -0.2f, -0.1f, 0f, 0.1f, 0.2f, 0.3f };
        ...
        public override string GetTolltipText(Item item)
        {
            ...
            return $"{percent1}% chance to Magma Orb for {percent2}% damage that leaves Burning Air({plusMinus}{percent3}%)";
        }
