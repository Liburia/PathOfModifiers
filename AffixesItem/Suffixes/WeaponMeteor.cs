...
namespace PathOfModifiers.AffixesItem.Suffixes
{
    public class WeaponMeteor : Suffix, ITieredStatFloat3Affix
    {
        ...
        static float[] tiers2 = new float[] { 0f, 0.66f, 1.33f, 2f, 2.66f, 3.33f, 4f };
        ...
        static float[] tiers3 = new float[] { -1.5f, -1f, -0.5f, 0f, 0.5f, 1f, 1.5f };
        ...
        public override string GetTolltipText(Item item)
        {
            ...
            float percent3 = Math.Abs(Multiplier3 * 100);
            ...
            string plusMinus = multiplier3 >= 0 ? "+" : "-";

            return $"{percent1}% chance to Meteor for {percent2}% damage that Ignites({plusMinus}{percent3}%) and leaves Burning Air({plusMinus}{percent3}%)";
        }
