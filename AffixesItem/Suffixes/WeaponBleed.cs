...
namespace PathOfModifiers.AffixesItem.Suffixes
{
    ...
    {
        public override float weight => 99.5f;
        ...
        void Bleed(NPC target, int hitDamage)
        {
            ...
            pomNPC.AddDoTBuff(target, ModContent.GetInstance<Bleed>(), damage, duration);
        }
        void Bleed(Player target, int hitDamage)
        {
            ...
            pomPlayer.AddDoTBuff(target, ModContent.GetInstance<Bleed>(), damage, duration);
        }
