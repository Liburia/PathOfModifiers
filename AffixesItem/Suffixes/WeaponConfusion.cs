...
{
    public class WeaponConfusion : Suffix, ITieredStatFloat2Affix
    {
        ...
        public override string GetTolltipText(Item item)
        {
            ...
            return $"{percent1}% chance to confuse enemy for {percent2}s";
        }
        ...
        {
            if (item == player.HeldItem && Main.rand.NextFloat(1) < multiplier1)
            {
                int durationTicks = (int)Math.Round(multiplier2 * 60);
