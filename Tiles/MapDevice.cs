...
//        {
//            if (Main.netMode != 1)
//                Item.NewItem(new Vector2(i * 16, j * 16), ModContent.ItemType<Items.MapDevice>());
...
//                else
//                    player.cursorItemIconID = ModContent.ItemType<Items.MapDevice>();
...
//                    var itemTexture = Terraria.GameContent.TextureAssets.Item[mapDevice.mapItem.type].Value;
//                    var itemSize = 24;
