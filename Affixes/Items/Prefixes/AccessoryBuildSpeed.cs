...
{
    public class AccessoryBuildSpeed : AffixTiered<TTFloat>, IPrefix
    {
        ...
        public override TTFloat Type1 { get; } = new TTFloat()
        {
            ...
            {
                new TTFloat.WeightedTier(-0.10f, -0.06f, 0.5),
                new TTFloat.WeightedTier(-0.06f, -0.03f, 1),
                new TTFloat.WeightedTier(-0.03f, -0.01f, 2),
                new TTFloat.WeightedTier(0.01f, 0.03f, 2),
                new TTFloat.WeightedTier(0.03f, 0.06f, 1),
                new TTFloat.WeightedTier(0.06f, 0.10f, 0.5),
            },
        };
        ...
        public override string GetAffixText(bool useChatTags = false)
        {
            ...
            return Language.GetText("Mods.PathOfModifiers.Affixes.Prefixes.AccessoryBuildSpeed").Format( plusMinus, valueRange1 );
        }
