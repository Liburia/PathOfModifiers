...
namespace PathOfModifiers.Affixes.Items.Suffixes
{
    public class WeaponFrostPulse : AffixTiered<TTFloat, TTFloat, TTFloat>, ISuffix
    {
        ...
        public override string GetAffixText(bool useChatTags = false)
        {
            ...
            return Language.GetText("Mods.PathOfModifiers.Affixes.Suffixes.WeaponFrostPulse").Format( valueRange1 ,  valueRange2 ,  Keyword.GetTextOrTag(KeywordType.Chill, useChatTags) ,  plusMinus ,  valueRange3 );
        }
        ...
        {
            SoundEngine.PlaySound(SoundID.Item28.WithVolumeScale(0.3f).WithPitchOffset(0.3f), player.Center);
        }
    }
}