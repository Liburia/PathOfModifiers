    ...
    public class AccessoryVelocity : AffixTiered<TTFloat>, ISuffix
    {
        ...
        public override TTFloat Type1 { get; } = new TTFloat()
        {
            ...
            Tiers = new TTFloat.WeightedTier[]
            {
                ...
                new TTFloat.WeightedTier(-3, 1, 2),
                new TTFloat.WeightedTier(1, 3, 2),
        ...
        public override string GetAffixText(bool useChatTags = false)
        {
            ...
            return Language.GetText("Mods.PathOfModifiers.Affixes.Suffixes.AccessoryVelocity").Format( valueRange1 ,  towardsAway );
        }
