...
namespace PathOfModifiers.Affixes.Items.Suffixes
{
    public class AccessoryDodgeChance : AffixTiered<TTFloat, TTFloat, TTFloat>, ISuffix
    {
        ...
        public override string GetAffixText(bool useChatTags = false)
        {
            ...
            return Language.GetText("Mods.PathOfModifiers.Affixes.Suffixes.AccessoryDodgeChance").Format( valueRange1 ,  Keyword.GetTextOrTag(KeywordType.Dodge, useChatTags) ,  valueRange2 ,  valueRange3 );
        }
