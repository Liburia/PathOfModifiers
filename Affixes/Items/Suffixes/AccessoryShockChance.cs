...
namespace PathOfModifiers.Affixes.Items.Suffixes
{
    public class AccessoryShockChance : AffixTiered<TTFloat, TTFloat>, ISuffix
    {
        ...
        public override string GetAffixText(bool useChatTags = false)
        {
            ...
            return Language.GetText("Mods.PathOfModifiers.Affixes.Suffixes.AccessoryShockChance").Format( valueRange1 ,  Keyword.GetTextOrTag(KeywordType.Shock, useChatTags) ,  plusMinus ,  valueRange2 );
        }
