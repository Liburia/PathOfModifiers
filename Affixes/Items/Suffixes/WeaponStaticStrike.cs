    ...
    public class WeaponStaticStrike : AffixTiered<TTFloat, TTFloat, TTFloat>, ISuffix
    {
        ...
        public override TTFloat Type1 { get; } = new TTFloat()
        {
            ...
            Tiers = new TTFloat.WeightedTier[]
            {
                ...
                new TTFloat.WeightedTier(3f, 2.5),
                new TTFloat.WeightedTier(6f, 2),
                new TTFloat.WeightedTier(9f, 1.5),
                new TTFloat.WeightedTier(12f, 1),
                new TTFloat.WeightedTier(15f, 0.5),
                new TTFloat.WeightedTier(18f, 0),
            },
        };
        ...
        public override TTFloat Type3 { get; } = new TTFloat()
        {
            ...
            Tiers = new TTFloat.WeightedTier[]
            {
                ...
                new TTFloat.WeightedTier(0.87f, 2.5),
                new TTFloat.WeightedTier(0.73f, 2),
                new TTFloat.WeightedTier(0.6f, 1.5),
                new TTFloat.WeightedTier(0.47f, 1),
                new TTFloat.WeightedTier(0.33f, 0.5),
