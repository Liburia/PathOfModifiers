...
namespace PathOfModifiers.Affixes.Items.Suffixes
{
    public class WeaponSafety : AffixTiered<TTFloat>, ISuffix
    {
        ...
        public override TTFloat Type1 { get; } = new TTFloat()
        {
            ...
            {
                new TTFloat.WeightedTier(0f, 30f, 3),
                new TTFloat.WeightedTier(30f, 60f, 1.5),
                new TTFloat.WeightedTier(60f, 90f, 0.5),
            },
        };
        ...
        {
            return $"Gain safety buffs on hit for {Type1.GetValueFormat(1)}s";
        }
