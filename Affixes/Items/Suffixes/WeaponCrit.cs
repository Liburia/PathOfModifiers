...
namespace PathOfModifiers.Affixes.Items.Suffixes
{
    public class WeaponCrit : AffixTiered<TTFloat, TTFloat>, ISuffix
    {
        ...
        public override TTFloat Type1 { get; } = new TTFloat()
        {
            ...
            {
                new TTFloat.WeightedTier(-0.86f, -0.8f, 0.5),
                new TTFloat.WeightedTier(-0.8f, -0.67f, 1),
                new TTFloat.WeightedTier(-0.67f, 0f, 2),
                new TTFloat.WeightedTier(0f, 2f, 2),
                new TTFloat.WeightedTier(2f, 4f, 1),
                new TTFloat.WeightedTier(4f, 6f, 0.5),
            },
        };
