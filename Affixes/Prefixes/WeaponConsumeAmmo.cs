...
{
    public class WeaponConsumeAmmo : Prefix, ITieredStatFloatAffix
    {
        ...
        static float[] tiers = new float[] { 0f, 0.12f, 0.24f, 0.36f, 0.48f, 0.6f, 0.75f };
        ...
        {
            TooltipLine line = new TooltipLine(mod, "WeaponConsumeAmmo", $"[T{tierText}] {(int)Math.Round(multiplier * 100)}% chance to not consume ammo");
