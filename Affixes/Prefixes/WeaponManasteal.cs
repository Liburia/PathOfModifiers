...
{
    public class WeaponManasteal : Prefix, ITieredStatAffix
    {
        ...
        static float[] tiers = new float[] { 0f, 0.03f, 0.07f, 0.1f, 0.13f, 0.17f, 0.2f };
        ...
        {
            TooltipLine line = new TooltipLine(mod, "WeaponManasteal", $"[T{tierText}] {(int)Math.Round(multiplier * 100)}% manasteal");
