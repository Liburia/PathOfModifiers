...
{
    public class WeaponKnockbackPerLife : Prefix, ITieredStatFloatAffix
    {
        ...
        public override void ModifyTooltips(Mod mod, Item item, List<TooltipLine> tooltips)
        {
            ...
            TooltipLine line = new TooltipLine(mod, "WeaponKnockbackPerLife", $"[T{tierText}] Up to {(multiplier < 1 ? '-' : '+')}{percent}% knockback above 50% life and up to {(multiplier < 1 ? '+' : '-')}{percent}% below");
