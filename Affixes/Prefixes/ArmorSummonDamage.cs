...
{
    public class ArmorSummonDamage : Prefix, ITieredStatFloatAffix
    {
        ...
        static float[] tiers = new float[] { 0.9f, 0.93f, 0.97f, 1f, 1.03f, 1.07f, 1.1f };
        ...
        {
            TooltipLine line = new TooltipLine(mod, "ArmorSummonDamage", $"[T{tierText}] {(multiplier < 1 ? '-' : '+')}{(int)Math.Round(Math.Abs((multiplier - 1) * 100))}% summon damage");
        ...
        {
            player.minionDamage += multiplier - 1;
        }
