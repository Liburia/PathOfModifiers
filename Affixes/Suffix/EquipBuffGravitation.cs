...
{
    public class EquipBuffGravitation : Suffix
    {
        public override float weight => 0.5f;

        public override string addedText => "of Gravitation";
        ...
        {
            TooltipLine line = new TooltipLine(mod, "EquipBuffGravitation", "Player can control gravity");
        ...
        {
            player.player.AddBuff(BuffID.Gravitation, 2);
        }
