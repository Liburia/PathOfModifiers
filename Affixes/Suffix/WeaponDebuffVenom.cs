...
{
    public class WeaponDebuffVenom : Suffix, ITieredStatFloatAffix
    {
        ...
        {
            TooltipLine line = new TooltipLine(mod, "WeaponDebuffVenom", $"[T{tierText}] {(int)Math.Round(multiplier * 100)}% chance to venom enemies for 3-10 seconds on hit");
