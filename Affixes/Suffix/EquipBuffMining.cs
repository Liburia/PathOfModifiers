...
{
    public class EquipBuffMining : Suffix
    {
        public override float weight => 0.5f;

        public override string addedText => "of Mining";
        ...
        {
            TooltipLine line = new TooltipLine(mod, "EquipBuffMining", "Player mines faster");
        ...
        {
            player.player.AddBuff(BuffID.Mining, 2);
        }
