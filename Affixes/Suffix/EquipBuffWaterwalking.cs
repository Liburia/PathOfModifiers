...
{
    public class EquipBuffWaterwalking : Suffix
    {
        public override float weight => 0.5f;

        public override string addedText => "of Waterwalking";
        ...
        {
            TooltipLine line = new TooltipLine(mod, "EquipBuffDangersense", "Player can walk on water");
