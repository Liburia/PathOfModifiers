...
{
    public class Damage : Prefix, Affixes.ITieredStatFloatAffix
    {
        ...
        {
            return
                PoMItem.IsAccessory(npc);
        }

        public override string GetTolltipText(NPC npc)
        {
        ...
        {
            Affixes.TieredAffixHelper.SetTier(this, tier);
        }
        void SetTierMultiplier(float tierMultiplier)
        {
            Affixes.TieredAffixHelper.SetTierMultiplier(this, tierMultiplier);
        }
        public override Affix Clone()
        {
            return Affixes.TieredAffixHelper.Clone(this, (Affixes.ITieredStatFloatAffix)base.Clone());
        }
        public override void RollValue(bool rollTier = true)
        {
            Affixes.TieredAffixHelper.RollValue(this, rollTier);
        }
        public override void Save(TagCompound tag, Item item)
        {
            Affixes.TieredAffixHelper.Save(this, tag, item);
        }
        public override void Load(TagCompound tag, Item item)
        {
            Affixes.TieredAffixHelper.Load(this, tag, item);
        }
        public override void NetSend(Item item, BinaryWriter writer)
        {
            Affixes.TieredAffixHelper.NetSend(this, item, writer);
        }
        public override void NetReceive(Item item, BinaryReader reader)
        {
            Affixes.TieredAffixHelper.NetReceive(this, item, reader);
        }
        #endregion
    }
}
