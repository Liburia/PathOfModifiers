...
namespace PathOfModifiers.UI.Chat
{
    ...
    public static class Keyword
    {
        ...
        /// <summary>
        /// Get either the name or the correspondig tag for the keyword
        /// </summary>
        public static string GetTextOrTag(KeywordType type, bool isTag = true)
        {
            KeywordDefinition keyword = keywords[(int)type];
            if (isTag)
            {
                return KeywordTagHandler.GenerateTag(type);
            }
            else
            {
                return keyword.Name;
    ...
    public class KeywordTagHandler : ITagHandler
    {
        ...
        {
            private readonly Keyword.KeywordDefinition _keyword;
            ...
            {
                return ChatManager.WaveColor(_keyword.Color);
            }
